...
There are several files on the above zipped file. But it is mainly divided into two groups of files as per the design of this study, namely, the **train** and **test** data sets. For example the **x_train.txt** and **x_test.txt** contains the performance sets of the 70% and 30% of the subjects respectively.  And the **y_train.txt** and **y_test.txt** contains the sets of activity perform by agai 70% and 30% of the subjects respectively. As mentioned above there are 30 subjects on this experiments. Also **activity_label.txt** contains the activity description of the subject, namely, *WALKING*, *WALKING_UPSTAIRS*, *WALKING_DOWNSTAIRS*, *SITTING*, *STANDING* and *LAYING*. 
